...
const GOALS = [
  ...
  { icon: Droplet, text: "إعادة تأهيل شبكات المياه والصرف الصحي في المنطقة المستهدفة" },
          ...
          <div className="hero-content">
            <div>
              ...
              <div className="hero-meta">
                ...
                <span>
                  <Calendar size={16} /> {campaign.startDate} — {campaign.endDate}
                </span>
                <span>
                  <Clock size={16} /> {campaign.startTime} — {campaign.endTime} يوميًا
                </span>
              </div>
            </div>
            ...
            <div className="progress-card">
              <div className="amount-row">
                ...
                <div className="amount-target">
                  من أصل <b>{campaign.target.toLocaleString("en-US")}$</b> مستهدف
                </div>
              </div>
              ...
              <div className="stat-mini-row">
                <div className="stat-mini">
                  <div className="num">{campaign.donors.toLocaleString("en-US")}</div>
