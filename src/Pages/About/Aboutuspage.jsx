    ...
    >
        ...
        <CustomContainer>
          ...
          >
            ...
            >
              <Chip
                icon={
                  <FavoriteRoundedIcon sx={{ color: `${C.gold} !important` }} />
                }
                label='من نحن'
                sx={{
              ...
              >
                ...
                >
                  منصة لتنظيم حملات التبرع وربط أصحاب القضايا الإنسانية بمن يؤمن
                  بها لتصبح عملية العطاء أكثر وضوحًا وشفافية من خلال حملات
                  موثوقة، ومشاريع مُجزَّأة، وتقارير تعكس أثر كل مساهمة.
                </Typography>
              </Stack>
            </Stack>
          </Box>
      ...
      <Section>
        ...
        >
          ...
          >
            <SectionHeading eyebrow='قصتنا' title='' center={false} />
            ...
            >
              رأينا حملات تبرع كثيرة تضيع جهودها بسبب غياب الشفافية، ورأينا
              متبرعين أصحاب نوايا صادقة لا يجدون الطريق الصحيح لإيصال مساعدتهم.
              ومن هنا قررنا أن نبني جسراً حقيقياً بين من يملك القدرة على العطاء،
              ومن ينتظر يداً تمتد إليه.
            </Typography>
      ...
      {/* ===================== الرسالة و الرؤية ===================== */}
      <Section bg={C.white}>
        <SectionHeading eyebrow='هويتنا' title='مهمتنا ورؤيتنا وقيمنا' />
          ...
          {[
            {
              ...
              title: 'مهمتنا',
              text: 'أن نجعل التبرع أسهل وأكثر شفافية وأعمق أثراً، عبر حملات منظمة تُقسَّم إلى مشاريع محددة يتابع فيها كل متبرع تأثير مساهمته بدقة.',
            },
            {
              icon: <VisibilityRoundedIcon sx={{ color: C.white }} />,
              title: 'رؤيتنا',
              text: 'مجتمع لا تقف فيه القدرة المالية حائلاً دون مساعدة الآخرين، ولا يقف فيه غياب الثقة عائقاً أمام الكرم.',
            },
            {
              icon: <FavoriteRoundedIcon sx={{ color: C.white }} />,
              title: 'قيمنا',
              text: 'الشفافية، المصداقية، والمسؤولية هي المبادئ التي تقود جميع أعمالنا، لنضمن وصول كل مساهمة إلى المكان الذي تستحقه.',
            },
          ].map((item, i) => (
      ...
      <Section bg={C.white}>
        <SectionHeading
          eyebrow='لماذا نحن مختلفون'
          title='نبني الثقة قبل أن نطلب العطاء'
        />
          ...
          {[
            {
              ...
              text: 'تعرف بالضبط إلى أين ذهب تبرعك وما الأثر الذي صنعه.',
            },
            {
              icon: <AccountTreeRoundedIcon />,
              title: 'تنظيم لا فوضى',
              text: 'حملات مقسّمة إلى مشاريع واضحة بأهداف قابلة للقياس.',
            },
            {
              icon: <GroupsRoundedIcon />,
              title: 'مساحة للجميع',
              text: 'من الفرد إلى المؤسسة، كل عطاء له مكانه هنا.',
            },
            {
              icon: <FavoriteRoundedIcon />,
              title: 'الأثر فوق كل شيء',
              text: 'نقيس نجاحنا بعدد الأرواح التي لمسناها، لا عدد الحملات.',
            },
          ].map((f, i) => (
            <Box
              key={i}
            ...
            >
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: 14, color: C.muted, lineHeight: 1.7 }}
                >
                  {f.text}
                </Typography>
              </Stack>
      ...
      >
        <CustomContainer>
          ...
          >
            نؤمن أن الشفافية تبدأ بالأرقام، لذلك نشارككم باستمرار نتائج حملاتنا
            وتأثير مساهماتكم على أرض الواقع.
          </Typography>
        </CustomContainer>
              ...
              >
                ...
                <Box sx={{ position: 'relative' }}>
                  ...
                  <Box sx={{ textAlign: 'left' }}>
                    ...
                    <Typography
                      sx={{ fontSize: 14, color: C.muted, lineHeight: 1.9 }}
                    >
                      {d.text}
                    </Typography>
      ...
      <Section>
        <SectionHeading
          eyebrow='آلية العمل'
          title='من القضية إلى الأثر، بثلاث خطوات'
        />
        ...
        >
          {[
            {
              icon: (
                <CampaignRoundedIcon sx={{ fontSize: 28, color: C.white }} />
              ),
              title: 'الحملة',
            ...
            {
              icon: (
                <AccountTreeRoundedIcon sx={{ fontSize: 28, color: C.white }} />
              ),
              title: 'المشاريع',
      ...
      <Section>
        <Box sx={{ textAlign: 'center', maxWidth: 640, mx: 'auto' }}>
          ...
          <Typography
            sx={{ fontSize: 16, color: C.muted, lineHeight: 2, mb: 4 }}
          >
            سواء كنت متبرعاً يبحث عن قضية يؤمن بها، أو منظمة تبحث عن وصول أوسع —
            معاً، نصنع أثراً لا يُنسى.
          </Typography>
